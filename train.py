...
def valid(args, model, writer, valid_loader, global_step):
    ...
    writer.add_scalar("valid/loss", scalar_value=eval_losses.val, global_step=global_step)
...
def test(args, model, writer, test_loader, global_step):
    ...
    target_names = ['creamy_paste', 'diced', 'grated', 'juiced', 'jullienne', 'sliced', 'whole']
...
def main():
    ...
    parser.add_argument("--dataset", choices=["cifar10", "cifar100", "CookingState"], default="CookingState",
                        help="Which downstream task.")
    parser.add_argument("--model_type", choices=["ViT-B_16", "ViT-B_32", "ViT-L_16",
                                                 "ViT-L_32", "ViT-H_14", "R50-ViT-B_16"],
                        default="ViT-B_16",
                        help="Which variant to use.")
    parser.add_argument("--pretrained_dir", type=str, default="no_weights",
